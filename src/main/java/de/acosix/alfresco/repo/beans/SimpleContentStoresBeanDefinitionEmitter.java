 ...
 */
package de.acosix.alfresco.repo.beans;
...
public class SimpleContentStoresBeanDefinitionEmitter implements BeanDefinitionRegistryPostProcessor, InitializingBean
{
    ...
    private static final String PROP_ROOT_STORE = "contentStores.rootStore";

    private static final String PROP_CUSTOM_STORES = "contentStoress";

    private static final String PROP_CUSTOM_STORE_PREFIX = "contentStores";
    ...
    public void postProcessBeanDefinitionRegistry(final BeanDefinitionRegistry registry) throws BeansException
    {
        if (!this.executed)
        {
            LOGGER.info("Generating content-stores bean definitions");
