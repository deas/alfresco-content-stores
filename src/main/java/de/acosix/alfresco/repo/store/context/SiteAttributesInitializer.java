 ...
 */
package de.acosix.alfresco.repo.store.context;
 ...
 * the current {@link ContentStore#getWriter(ContentContext) getWriter}-call if possible. The initializer will check for the presence of a
